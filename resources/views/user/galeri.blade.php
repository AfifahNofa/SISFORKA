...
<body>
    ...
    <div class="container">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                <tr>
                    <td><img width="100" height="50" src="images/5e72f65c1f909-teamwork-desktop2.jpg"
                            alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="{{ url('/perGaleri') }}" class="btn btn-success">Selengkapnya</a></td>
                </tr>
                ...
                <tr>
                    <td><img width="100" height="50" src="images/5e72f68fbd34a-excellent-desktop2.jpg"
                            alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-success">Selengkapnya</a></td>
                </tr>

                <tr>
                    <td><img width="100" height="50" src="images/5e72f6adbf417-commitment2-desktop.jpg"
                            alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-success">Selengkapnya</a></td>
                </tr>
                ...
                <tr>
                    <td><img width="100" height="50" src="images/5e72f7134ca67-integrity-desktop2.jpg"
                            alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-success">Selengkapnya</a></td>
                </tr>
                ...
                <tr>
                    <td><img width="100" height="50" src="images/5e72f72cca561-respect-desktop2.jpg"
                            alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-success">Selengkapnya</a></td>
                </tr>
                ...
                <tr>
                    <td><img width="100" height="50" src="images/5e72f74b99ff0-humility-desktop2.jpg"
                            alt=""></td>
                    <td>Pramuka</td>
                    <td><a href="" class="btn btn-success">Selengkapnya</a></td>
                </tr>
