...
<body>
    ...
    <div class="container kontak">
        ...
        <div class="title">
            <h1 class="text-center">Visi MISI SDN Jatimulyo 1</h1>
        </div>
        <div class="card-body">
            <h3 class="mb-4">Visi Sekolah</h3>

            <p>
                Berangkat dari kondisi yang ada pada SDN Jatimulyo 1, maka SDN Jatimulyo I
                mempunyai visi: "TERCAPAINYA SEKOLAH YANG UNGGUL DALAM PRESTASI BERLANDASKAN IMTAQ, IPTEK DAN BERBUDAYA
                PANCASILA SERTA PEDULI LINGKUNGAN"

            <h5>Indikator Visi Sekolah </h5>
            <li>Terwujudnya budaya tertib, disiplin, santun dalam ucapan sopan dalam perilaku terhadap sesama
                berlandaskan iman dan taqwa</li>
            <li>Unggul prestasi hasil belajar siswa haik akademik maupun non akademik</li>
            <li>Unggul prestasi ujian sekolah, mampu bersaing dan meningkatkan prosentase lulusan yang diterima
                di SLTP Negeri /Unggulan</li>
            <li>Unggul prestasi dalam berbagai even lomba baik akademik maupun non akademik. </li>
            <li>Cerdas, terampil dan memiliki kemampuan dasar life skill sebagai salah satu bekal hidup mandiri di
                masa depan.</li>
            <li>Unggul dalam penguasaan IPTEK dan penerapannnya serta mampu mengikuti arus perkembangannya.</li>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="footerContactUs">
                                ...
                                <div class="perFooterContactUs">
                                    ...
                                    <p class="text-white">Jl. Pisang Kipas No.36, RT.07, RW.04 Kec.Lowokwaru
                                        Kota.Malang
                                    </p>
                                </div>
