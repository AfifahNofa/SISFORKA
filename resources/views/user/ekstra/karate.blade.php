...
<body>
    ...
    <div class="container">
        <h3 class="titleEkstrakulikuler">Ekstrakulikuler Karate</h3>
                ...
                <div class="card-header" id="headingTwo">
                    <h2 class="mb-0">
                        <button class="btn btn-block text-left collapsed" type="button" data-toggle="collapse"
                            ...
                            1. Pembina Ekstrakulikuler Karate
                        </button>
                    </h2>
                </div>
            ...
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        <h4>Materi</h4>
                        <p>
                            <li>Gerakan Dasar Pukulan Ouzuki Jodan
                            <li>Gerakan Tendangan Maigeri Mawashi Keikomi Geri</li>
                        </p>
